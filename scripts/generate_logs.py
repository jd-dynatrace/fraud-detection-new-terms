...
Sends log records to /api/v2/logs/ingest with event.type=banking.transaction.
...
print("\nVerify with DQL:")
print('  fetch logs, from:now()-1h | filter `event.type` == "banking.transaction" | sort timestamp desc')
